...
| `EMB-P4-NFR-002` | Passed | Detached commit `ed19552` completed `npm ci --offline`, then passed `verify:replay`, `verify:preview`, lint, production build, and the local-build audit. |
...
| `EMB-P4-AC-004` | In progress | Clean-checkout checks are green at `ed19552`; Phase 3’s required manual evidence, second-builder review, and the frozen commit remain open. |
